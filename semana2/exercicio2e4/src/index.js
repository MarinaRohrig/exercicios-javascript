// import diminuir from "./maisUm.js";
...
//document.body.innerText = 'Inner Text';

// aqui pede uma requisição da página da wikipedia
// async informa que tem um tempo de espera ( do await) antes de funcionar a função 
// Exercicio 4:
